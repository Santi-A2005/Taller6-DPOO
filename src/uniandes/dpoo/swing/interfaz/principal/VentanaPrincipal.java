...
public class VentanaPrincipal extends JFrame
{
    ...
    {
        Restaurante newRes = new Restaurante(nombre, calificacion, x, y, visitado);
        mundo.agregarRestaurante(newRes);
        List<Restaurante> listaRes = getRestaurantes(true);
        pLista.actualizarRestaurantes(listaRes);
    }
